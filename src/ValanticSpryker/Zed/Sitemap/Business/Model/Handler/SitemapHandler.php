...
namespace ValanticSpryker\Zed\Sitemap\Business\Model\Handler;
...
class SitemapHandler implements SitemapHandlerInterface
{
    ...
    /**
     * @var \ValanticSpryker\Zed\Sitemap\SitemapConfig
     */
    protected $config;

    /**
     * @param \ValanticSpryker\Zed\Sitemap\Persistence\SitemapQueryContainerInterface $queryContainer
